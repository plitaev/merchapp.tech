...
class DevTestController extends Controller
{
    public function devtest() {
        ...
        $fulls_td = Pay::select('bot_user_id')->whereNot('product_id', 27)->where('status', 1)->whereIn('bot_user_id', $users_td)->where('created_at', '>=', '2026-01-03 10:00:00')->groupBy('bot_user_id')->count();
