...
class DevTestController extends Controller
{
    public function devtest() {
        ...
        $ids = Pay::select('bot_user_id')->whereIn('bot_user_id', $pays)->where('status', 1)->whereIn('product_id', 1)->where('created_at', '>=', '2025-10-17 10:00:00')->pluck('bot_user_id')->toArray();
