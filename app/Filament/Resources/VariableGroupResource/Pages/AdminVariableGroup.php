...
class AdminVariableGroup extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'filament.resources.variable-group-resource.pages.admin-variable-group';
        ...
        return $table
            ...
            ->columns([
                Tables\Columns\TextColumn::make('name')
                    ->label('Название')
                    ->searchable(),
                Tables\Columns\TextColumn::make('variable_system_variable_system_type.name')
                    ->label('Тип'),
                Tables\Columns\ViewColumn::make('status')->view('filament.resources.variable-groups-resource.columns.variable_value')
                    ->label('Значение')
            ])
            ->filters([
                //
            ...
            ->actions([
                Tables\Actions\EditAction::make()->url(fn($record) => "https://app.kovalchuk.tech/admin/variables-systems/".$this->id."/".$record->id."/admin"),
