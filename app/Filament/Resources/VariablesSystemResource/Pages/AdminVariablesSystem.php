...
class AdminVariablesSystem extends Page implements HasForms
{
    ...
    protected static string $view = 'filament.resources.variables-system-resource.pages.admin-variables-system';
                ...
                Section::make('Тип группы, которую видит пользователь')
                    ...
                    ->schema([
                        ...
                        Forms\Components\TextInput::make('name')
                            ...
                            ->label('Наименование')
                            ->maxLength(255),
                        Forms\Components\Select::make('variable_system_type_id')
                            ->label('Тип значения')
                            ->required()
