...
class BotGetCourseSettings extends Page implements HasTable
{
    ...
    protected static string $view = 'filament.resources.bot-resource.pages.bot-getcourse-settings';
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                Tables\Columns\ViewColumn::make('webhook')->view('filament.resources.product-resource.columns.getcourse_webhook')
                    ->label('Вебхук'),
