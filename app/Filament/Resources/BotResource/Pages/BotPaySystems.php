...
class BotPaySystems extends Page implements HasTable
{
    use InteractsWithTable;

    protected static string $resource = BotResource::class;

    protected static string $view = 'filament.resources.bot-resource.pages.bot-pay-systems';

    public static ?string $label = "Платежная система Юкасса";
    public static ?string $navigationLabel = "Платежные системы Юкасса";
