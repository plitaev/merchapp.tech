...
class BotMessageButtonAdmin extends Page implements HasForms
{
    ...
    protected static string $view = 'filament.resources.bot-resource.pages.bot-message-button-admin';
            ...
            ->schema([
                Section::make('Тип кнопки и надпись, которую видит пользователь')
                    ...
                    ->schema([
                        ...
                        Forms\Components\Select::make('bot_message_button_type_id')
                            ->label('Тип кнопки')
                            ->required()
                        ...
                        Forms\Components\TextInput::make('name')
                            ...
                            ->maxLength(255),
                        Forms\Components\Select::make('pos')
                ...
                Section::make('Сбор статистики')
                    ...
                    ->schema([
                        Forms\Components\Toggle::make('tracking')
                ...
                Section::make('Выберите функцию, которая должна вызываться по клику на кнопке')
                    ->schema([
                        Forms\Components\Select::make('bot_message_callback_id')
                            ->label('Функция')
