...
class BotWizard extends Page implements HasForms
{
    ...
    protected string $view = 'filament.resources.bot-resource.pages.bot-wizard';
        ...
        return $schema
            ...
            ->schema([
                Wizard::make([
                    ...
                    Step::make('Создание групп')
                        ->schema([

                        ]),
                    Step::make('Создание продуктов')
                        ->schema([
