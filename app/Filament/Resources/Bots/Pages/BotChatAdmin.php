...
class BotChatAdmin extends Page implements HasForms, HasInfolists
{
    ...
    public function mount(int $bot_id, int $id): void
    {
        ...
        foreach ($bot_user_prices as $bot_user_price) {
            $this->bot_user_prices_individual .= "<p style='margin-bottom: 10px'>".$bot_user_price->product->name . ' - ' . $bot_user_price->price."</p>";
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                Section::make('Индивидуальные цены')->description(new HtmlString("<a href='' style='display: block; margin-bottom: 25px; color: #7a300d; font-weight: bold'>Добавить / Редактировать ▶️</a>".$this->bot_user_prices_individual))->schema([]),
