        ...
        return $schema
            ->components([
                ...
                Section::make('Статистика')
                    ->description(new HtmlString("<a style='font-weight: bold' href='/admin/bots/".$this->bot_id."/.".$this->bot_user_id."/telegram-send-message-logs'>Сообщения от бота: ".$this->bot_user_message_count."</a>"))
                    ->columns([
                        'sm' => 4,
                        'md' => 4,
                        'lg' => 4,
