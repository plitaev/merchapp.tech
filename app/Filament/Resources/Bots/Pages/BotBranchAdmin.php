    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                Section::make('Акция')
                    ->description(new HtmlString('Ссылка на запуск к акции в боте: <a href="https://t.me/'.$this->bot_alias.'?start='.$this->bot_branch_hash.'">https://t.me/'.$this->bot_alias.'?start='.$this->bot_branch_hash.'</a>'))
                    ->columns([
                        'sm' => 1,
                        'md' => 1,
                        'lg' => 1,
