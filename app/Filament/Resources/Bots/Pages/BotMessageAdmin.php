        ...
        return $schema
            ->components([
                ...
                Section::make('Видео в Max')
                    ->description(new HtmlString("<a style='font-weight: bold' href='/max/send_file/".$this->bot_id."/".$this->id."'>".$this->video_max_id."</a>"))
                    ->visible(function (Get $get) {
                        if (is_callable($get)) {
                            return $get('bot_message_type_id') == 3;
                        }
                ...
                Section::make('Аудио в Max')
                    ->description(new HtmlString("<a style='font-weight: bold' href='/max/send_file/".$this->bot_id."/".$this->id."'>".$this->audio_max_id."</a>"))
                    ->visible(function (Get $get) {
                        if (is_callable($get)) {
                            return $get('bot_message_type_id') == 4;
                        }
                ...
                Section::make('Файл в Max')
                    ->description(new HtmlString("<a style='font-weight: bold' href='/max/send_file/".$this->bot_id."/".$this->id."'>".$this->custom_file_max_id."</a>"))
                    ->visible(function (Get $get) {
                        if (is_callable($get)) {
                            return $get('bot_message_type_id') == 5;
                        }
