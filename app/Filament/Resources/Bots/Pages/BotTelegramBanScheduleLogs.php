...
class dBotTelegramBanScheduleLogs extends Page implements HasTable, HasInfolists
{
    ...
    protected string $view = 'filament.resources.bot-resource.pages.bot-telegram-ban-schedule-logs';
