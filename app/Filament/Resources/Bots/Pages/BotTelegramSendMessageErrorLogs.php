...
class BotTelegramSendMessageErrorLogs extends Page implements HasTable, HasInfolists
{
    ...
    protected string $view = 'filament.resources.bot-resource.pages.bot-telegram-send-message-error-logs';
