...
class AdminMiniAppPage extends Page implements HasTable, HasForms
{
    ...
    protected static string $view = 'filament.resources.mini-app-page-resource.pages.admin-mini-app-page';
    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->actions([
                Tables\Actions\EditAction::make()->url(fn($record) => "/admin/mini-app-banners/".$this->record."/".$record->mini_app_banner_id."/admin"),
