...
class ListenerResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\AdvancedListListener::route('/'),
            'create' => Pages\AdminListener::route('/{id}/admin'),
            'edit' => Pages\AdminListener::route('/{id}/admin'),
            'admin' => Pages\AdminListener::route('/{id}/admin'),
