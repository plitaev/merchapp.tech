...
class CreateMiniAppPageConstructor extends Page implements HasTable, HasForms
{
...
//        $this->form->fill($data);
    ...
    protected string $view = 'filament.resources.mini-app-page-constructor-resource.pages.admin-mini-app-page';
