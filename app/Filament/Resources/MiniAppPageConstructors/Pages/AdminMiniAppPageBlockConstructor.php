...
class AdminMiniAppPageBlockConstructor extends Page  implements HasForms,HasTable
{
    ...
    protected string $view = 'filament.resources.mini-app-page-constructor-resource.pages.mini-app-page-constructor-block';
                ...
                Actions::make([
                    Action::make('Сохранить')
                        ...
                        ->action(function () {
                            ...
                            return redirect('/admin/mini-app-page-constructors/' . $this->record . '/mini-app-page-constructor-block');
                    ...
                    Action::make('Cancel')
                        ->color('gray')
                        ->action(function () {
                            return redirect('/admin/mini-app-pages/' . $this->record . '/mini-app-page-constructor-blocks');
                        })
