...
class AdminFunnelMessage extends Page implements HasForms
{
    ...
    protected string $view = 'filament.resources.funnel-message-resource.pages.admin-funnel-message';
    ...
    public function form(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                TextInput::make('days_before_condition')
                    ->label('Дни до состояния')
                    ->maxLength(50),
                TextInput::make('hours_before_condition')
                    ->label('Часы до состояния')
                    ->maxLength(50),
                TextInput::make('minutes_before_condition')
                    ->label('Минуты до состояния')
                    ->maxLength(50),
                TextInput::make('days_after_condition')
                    ->label('Дни после состояния')
                    ->maxLength(50),
                TextInput::make('hours_after_condition')
                    ->label('Часы после состояния')
                    ->maxLength(50),
                TextInput::make('minutes_after_condition')
