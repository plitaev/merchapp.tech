            ...
            <nav class="fi-breadcrumbs" id="merchapp-top-nav">
                <ol class="fi-breadcrumbs-list">
                    ...
                    <li class="fi-breadcrumbs-item">
                        ...
                        <a href="/admin/bots/{{$this->bot_id}}/getcourse-settings" class="fi-breadcrumbs-item-label">Настройки GetCourse</a>
                    </li>
                </ol>
            </nav>

    <h1 class="fi-header-heading">Настройки GetCourse</h1>
        </div>
    </div>

    @include('filament.resources.bot-resource.pages.navigation-bot', ['category' => "getcourse-settings", 'bot_id' => $this->bot_id])
