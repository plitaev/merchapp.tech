            ...
            <nav class="fi-breadcrumbs" id="merchapp-top-nav">
                <ol class="fi-breadcrumbs-list">
                    ...
                    <li class="fi-breadcrumbs-item">
                        ...
                        <a href="/admin/bots/{{$this->bot_id}}/telegram-ban-schedules" class="fi-breadcrumbs-item-label">Баны</a>
                    </li>
                </ol>
            </nav>

    <h1 class="fi-header-heading">Баны</h1>
        </div>
    </div>
    @include('filament.resources.bot-resource.pages.navigation-bot', ['category' => "telegram-ban-schedules", 'bot_id' => $this->bot_id])

    @if (auth()->user()->can('Update:BotUserBanSchedule'))
