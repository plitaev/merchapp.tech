...
<x-filament-panels::page>
            ...
            <nav class="fi-breadcrumbs" id="merchapp-top-nav">
                <ol class="fi-breadcrumbs-list">
                    ...
                    <li class="fi-breadcrumbs-item">
                        ...
                        <a href="/admin/bots/{{$this->bot_id}}/telegram-unban-schedules" class="fi-breadcrumbs-item-label">Разбаны</a>
                    </li>
                </ol>
            </nav>
        </div>
    ...
    <div class="fi-header flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <h1 class="fi-header-heading text-2xl font-bold tracking-tight text-gray-950 dark:text-white sm:text-3xl">Разбаненные пользователи</h1>
        <div class="flex shrink-0 items-center gap-3">
            <x-filament::modal id="add-page-modal">
                <x-slot name="trigger">
                    <x-filament::button>Разбанить пользователя</x-filament::button>
                </x-slot>

                <form wire:submit.prevent="submit">{{$this->form_unban_user}}</form>
            </x-filament::modal>
        </div>
    </div>
    @endif
