...
@section('content')
    ...
    <div class="isolate overflow-y-scroll bg-[#f1f1f1] h-[100vh]">
        <div class="flow-root pb-24 sm:pb-32">
            ...
            <iframe width="560" height="315" src="https://cdn-vod.loverse.me/videos/12436_eHD7pGycewnsOh8V" frameborder="0" allow="autoplay; encrypted-media; clipboard-write" allowfullscreen></iframe>
        </div>
    </div>
