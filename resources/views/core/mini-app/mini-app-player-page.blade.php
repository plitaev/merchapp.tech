...
@section('content')
    ...
    <div class="isolate overflow-y-scroll bg-[#f1f1f1] h-[100vh]">
        <div class="flow-root pb-24 sm:pb-32">
            ...
            <iframe src="https://cdn-vod.loverse.me/videos/12436_kkgBYjtudTfdLKmg" allow="autoplay; encrypted-media; clipboard-write" allowfullscreen style="width: 100%"></iframe>
        </div>
    </div>
