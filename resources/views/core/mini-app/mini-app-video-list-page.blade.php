        ...
        <div class="flow-root pb-24 sm:pb-32">
            ...
            <div class="mx-5">
                @foreach ($videos as $video)
                    ...
                    <a href="/miniapp/player/{{$video->id}}/MESSENGER_USER_ID/{{$back_page}}" class="ref-to-player flex justify-between align-center text-md font-semibold text-indigo-500">
